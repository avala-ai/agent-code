---
title: "Installation"
description: "Install Agent Code on macOS, Linux, and Windows"
---

## Requirements

- A supported LLM credential (API key or subscription login — see [Authentication](./authentication.mdx))
...
- [Terminal support](./terminal-support.mdx) for TUI issues under tmux/SSH
