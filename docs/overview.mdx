---
title: "Overview"
description: "Open-source AI coding agent for the terminal — TUI, headless, ACP"
---
...
- [Install](./installation.mdx) · [Quickstart](./quickstart.mdx) · [User guide index](./user-guide/README.md)
- [Keyboard shortcuts](./keyboard-shortcuts.mdx) · [Authentication](./authentication.mdx)
