...
- [Providers](./configuration/providers.md) — model IDs and multi-provider setup
- [Headless mode](./headless.md) — scripting and CI flags
- [Security](./security.md) — what never leaves the machine by default
