...
description: "One-shot prompts, CI, JSON output, serve, and ACP"
---
...
Speaks Agent Client Protocol over stdio (JSON-RPC). Editors spawn this process and stream prompts, tool visibility, and permission requests. See [IDE bridge](./extending/ide-bridge.mdx).
